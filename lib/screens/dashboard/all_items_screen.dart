      ...
      builder: (context, snapshot) {
        ...
        final filteredProducts = products.where((product) {
          final matchesCategory = switch (_selectedCategory) {
            'Electrical Items' => product.category == 'Electric',
            'Electronic Items' => product.category == 'Electronic',
            _ => true,
          };
                        ...
                        children: [
                          IconButton(
                            ...
                            onPressed: () => Navigator.pushReplacement(
                              context,
                              MaterialPageRoute(
                                builder: (_) => const CategoryDashboard(),
                              ),
                            ),
                          ),
                                  ...
                                  child: ListTile(
                                    ...
                                    onTap: () {
                                      Navigator.push(
                                        ...
                                        MaterialPageRoute(
                                          builder: (_) =>
                                              ItemUsersScreen(product: product),
                                        ),
                                      );
                                    },
                                  ),
